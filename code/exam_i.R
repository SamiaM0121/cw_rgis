...
g_scat <- ggplot(iris, aes(x = Sepal.Width,
                           y = Sepal.Length)) +
  geom_point()
...
g_scat_col <- ggplot(iris, aes(x = Petal.Width,
                               y = Petal.Length,
                               color = Species)) +
  geom_point()
...
g_hist <- ggplot(PlantGrowth, aes(x = weight)) +
...
g_bplot1 <- ggplot(PlantGrowth, aes(x = group, 
                                    y = weight,
                                    fill = group)) +
  geom_boxplot()
...
g_bplot2 <- ggplot(PlantGrowth, aes(x = group,
                                    y = weight,
                                    fill = group)) +
